...
class SockProxy(Handler):
    ...
    def HandShakeWithLocal(self):
        ...
        self.sendLongByteUnit(HASH_SEED, to_socket=self.request)
        ...
        # step 4
        self.log("step4")
        X1 = self.getLongByteUnit(msg="X1")
        if X1 is None:
            return None
        EY1 = self.getLongByteUnit(msg="EY1")
        if EY1 is None:
            return None
        E1 = self.getLongByteUnit(msg="HASHED_1")
        if E1 is None:
            return None
        ...
        self.sendLongByteUnit(X2)
        self.sendLongByteUnit(EY2)
        self.sendLongByteUnit(E2)
        ...
        # step 8
        control_msg = self.getLongByteUnit("control_msg")
